...
def open_dict(Dict = 'name', path=r'./Sent_Dict/'):
    path = os.path.join(path,  '%s.txt' % Dict)
...
deny_word = open_dict(Dict = '否定词', path= current_path)
posdict = open_dict(Dict = 'positive', path= current_path)
negdict = open_dict(Dict = 'negative', path= current_path)
degree_word = open_dict(Dict = '程度级别词语', path= current_path)

# deny_word = open_file_as_text(current_path+'否定词.txt')
# posdict = open_file_as_text(current_path+'positive.txt')
# negdict = open_file_as_text(current_path+'negative.txt')
# degree_word = open_file_as_text(current_path+'程度级别词语.txt')
